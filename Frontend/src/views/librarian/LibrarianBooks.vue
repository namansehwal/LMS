<template>
    <div class="container mt-5">
        ...
        <div class="card-body">
          <form @submit.prevent="addBook">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="newBook.content" class="form-control" id="content" rows="3" required></textarea>
            </div>
            <div class="mb-3">
      ...
      <!-- Edit Book Form -->
      <div v-if="editingBook" class="card mt-4">
        <div class="card-header">
          Edit Book
        </div>
        <div class="card-body">
          <form @submit.prevent="updateBook">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="editingBook.content" class="form-control" id="editContent" rows="3" required></textarea>
            </div>
            <div class="mb-3">
